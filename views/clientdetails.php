  <div ng-controller='clientdetailsCtrl' ng-cloak="">
    <section class="content-header">
        <h1>
           Client and Users details
            <!--<small>Client and Users details</small>-->
        </h1>
<!--        <ol class="breadcrumb">
...
<!--      <div class="modal fade bd-example-modal-lg" id="myModal" role="dialog">
         ...
         <form class='col-md-12  alert alert-danger'>
             <div class='row'>
                 <div class='col-md-12'>
                     <div class="form-group">
            </div>
            <div class="row">
                <div class="col-md-4" >     <!-- ng-if="profile.app_id == 0"-->
                   <label> Application</label>
                    <select class="form-control" id="usersapp" ng-model="clientdetails.appid" n="app" ng-change="loadmanager();loadlogindetail()">
                ...
                <div class="col-md-4">    
                    ...
                    <select class="form-control"  n="Select User" ng-model="clientdetails.uid" ng-change="loadlogindetail()">
                            ...
                            <div class="col-md-4">
                                ...
                                <!--<div class="col-md-8">-->
                                    <div class="controls input-append date form_date" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                                        <input    type="date" class="form-control " ng-change="loadlogindetail();" size="8"  value=""  ng-model="clientdetails.end" placeholder="Start Date" >
                            ...
                            <div class="col-md-4">
                                ...
                                <!--<div class="col-md-8">-->
                                    <div class="controls input-append date form_date"  data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input3" data-link-format="yyyy-mm-dd">
                                        <input type="date"   class="form-control " ng-change="loadlogindetail();" size="8"  value=""  ng-model="clientdetails.start" placeholder="End Date">
                                        <span class="add-on"><i class="icon-remove"></i></span>
                                        <span class="add-on"><i class="icon-th"></i></span>
                                    </div>
...
<div class="col-md-6">
            ...
            <div class="col-md-6">
               ...
               <input type="text" ng-model="usernew.city" class="form-control  e" n="City" />  
                ...
                <button type="submit" id="submit" class="md-raised validate btn btn-default center-block" tar="#addUser" ng-click="usersave()" style="margin-top:3%;width:120px">Search</button>

            </div>

        </form>

<div ui-grid="gridOptions" ui-grid-selection ui-grid-pagination  ui-grid-cellnav ui-grid-exporter class="grid" style="margin-top: 25%;"></div>
    <div ng-include="'views/partialviews/allclientreportpopup.php?abc'"></div>
