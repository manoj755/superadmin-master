<div ng-controller='globalsettingCtrl' ng-cloak="">
    <section class="content-header">
        <h1>
            Dashboard 
            <small>GlobalSetting</small>
        </h1>
        <ol class="breadcrumb">
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Trackermaster</h4>
                    </div>
                    <div class="modal-body">
                        <p><div ui-grid="gridShowChannelTemplate" ui-grid-selection ui-grid-pagination  ui-grid-cellnav ui-grid-exporter class="grid"></div></p>
                                 <div class="col-md-4">
                ...
                <div class="bs-example" id="messagetemp">
                    <form class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label for="" class="control-label col-md-2">Terms</label>
                            <div class="col-md-6">
                                <input type="text" class="form-control" n="Terms" ng-model="channelmessage.terms">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="control-label col-md-2">Support</label>
                            <div class="col-md-6">
                                <input type="text" class="form-control" n="type" ng-model="channelmessage.support">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class=" col-xs-offset-2 col-xs-10">
                                <button type="submit" class="btn btn-primary" tar="#globalsetting" ng-hide="isEdit" ng-click="channelsave()">Save</button>
<!--                                <button type="button" class="btn btn-primary" tar="#channel" ng-show="isEdit" ng-click="trackerupdate()">Update</button>
                                <button type="button" class="btn btn-primary" tar="#channel" ng-show="isEdit" ng-click="back()">Back</button>-->
                            </div>
                        </div>
