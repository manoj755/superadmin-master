<div ng-controller='smsunsubscriberCtrl' ng-cloak="">
    <section class="content-header">
        <h1>
            Dashboard 
            <small>SMS Unsubscriber</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active"> SMS Unsubscriber</li>
        </ol>
    </section>
                ...
                <div class="bs-example" id="messagetemp">
                    <form class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label for="titile" class="control-label col-md-2">sms</label>
                            <div class="col-md-6">
                                <input type="text" class="form-control e" n="Template Name" ng-model="smsmessage.sms" id="titile" >
                            </div>
                        </div>
