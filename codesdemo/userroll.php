...
<h1>Store</h1>
 roleName : <input ng-model="store.roleName"  type="text"/> <br/>
...
<h1>Update</h1>
 ...
 roleName : <input ng-model="update.roleName"  type="text"/> <br/>
...
app.controller('customersCtrl', function($scope, $http,db,Authkey) {
    ...
    $scope.loadData=function(){
        db.list("userrole/",null,function (response) {$scope.list = response.data; 
    },function(response){
        //$scope.token=response.statusText;
    });}
 db.list("userrole/",null,function (response) {$scope.list = response.data; 
 ...
 $scope.stores=function(){
        db.store("userrole/",$scope.store,function (response) { 
    },function(response){
        //$scope.token=response.statusText;
    });}

 $scope.shows=function(){
        db.show("userrole/",$scope.show.id,function (response) { 
 ...
 $scope.deletes=function(){
        db.destroy("roleName/",$scope.delete.id,function (response) { 
         console.log(response);
