...
<h1>Store</h1>
 templateType: <input ng-model="store.templateType"  type="text"/> <br/>
 title: <input ng-model="store.title"  type="text"/> <br/>
 message: <input ng-model="store.message"  type="text"/> <br/>
 addedBy: <input ng-model="store.addedBy"  type="text"/> <br/>
...
<h1>Update</h1>
 ...
 messagetemplateName : <input ng-model="update.messagetemplateName"  type="text"/> <br/>
...
app.controller('customersCtrl', function($scope, $http,db,Authkey) {
    ...
    $scope.loadData=function(){
        db.list("messagetemplate/",null,function (response) {$scope.list = response.data; 
    },function(response){
        //$scope.token=response.statusText;
    });}
 db.list("messagetemplate/",null,function (response) {$scope.list = response.data; 
 ...
 $scope.stores=function(){
        db.store("messagetemplate/",$scope.store,function (response) { 
    },function(response){
        //$scope.token=response.statusText;
    });}

 $scope.shows=function(){
        db.show("messagetemplate/",$scope.show.id,function (response) { 
